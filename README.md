...
## Installing the Multi 4-in-1 boards
...
For detailed instructions, see the installation documentation [here](https://github.com/pascallanger/DIY-Multiprotocol-TX-Module/blob/master/docs/Arduino_IDE_Boards.md)
